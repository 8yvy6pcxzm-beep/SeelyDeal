...
export const ui = {
  tr: {
    ...
    authBlurb: "14 gün ücretsiz dene — kredi kartı gerekmez, dashboard'a hemen eriş.",
  ...
  en: {
    ...
    authBlurb: "Try it free for 14 days — no credit card required, get straight to your dashboard.",
