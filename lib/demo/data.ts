...
export const templates: Template[] = [
  ...
  {
    id: "t19",
    name: { tr: "Kurumsal & Ciddi", en: "Corporate & Formal" },
    category: { tr: "Kurumsal", en: "Corporate" },
    uses: 0,
    winRate: 0,
    accent: "var(--seg-1)",
    sections: GENERIC_SECTIONS,
    theme: { primaryColor: "#0b2545", accentColor: "#8a6d3b", font: "default" },
  },
  {
    id: "t20",
    name: { tr: "Minimalist & Temiz", en: "Minimalist & Clean" },
    category: { tr: "Modern", en: "Modern" },
    uses: 0,
    winRate: 0,
    accent: "var(--seg-2)",
    sections: GENERIC_SECTIONS,
    theme: { primaryColor: "#111827", accentColor: "#2563eb", font: "default" },
  },
  {
    id: "t21",
    name: { tr: "Canlı & Dinamik", en: "Vibrant & Dynamic" },
    category: { tr: "Yaratıcı", en: "Creative" },
    uses: 0,
    winRate: 0,
    accent: "var(--seg-3)",
    sections: GENERIC_SECTIONS,
    theme: { primaryColor: "#7c2d92", accentColor: "#f97316", font: "bold" },
  },
  {
    id: "t22",
    name: { tr: "Premium & Şık", en: "Premium & Elegant" },
    category: { tr: "Lüks & Hizmet", en: "Premium" },
    uses: 0,
    winRate: 0,
    accent: "var(--seg-4)",
    sections: GENERIC_SECTIONS,
