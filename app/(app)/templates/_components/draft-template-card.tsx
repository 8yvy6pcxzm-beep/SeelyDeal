...
/** Card for a "Taslak Teklif Örneği" group (kind: "draft" — real, usable starting
 *  content; see Template.kind in lib/demo/data.ts). Unlike VisualTemplateCard, this
 *  preview intentionally implies real text/pricing lives inside. */
export function DraftTemplateCard({
  group,
  selected,
  lang,
  t,
